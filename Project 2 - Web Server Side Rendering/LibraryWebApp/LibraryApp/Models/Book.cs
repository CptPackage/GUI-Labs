        ...
        public Book returnBook()
        {
            ...
            if (leased != "")
            {
                ...
                if(reserved != "")
                {
                    ...
                    b = new Book(id, author, title, publisher, date, user, reservedDate, leasedDate);
                }
                else
                {
                    //this case is improper since a book that has a lease date has to have a reserve date
                    b = new Book(id, author, title, publisher, date, user, null, null);
                }
            }
            else
            {
                ...
                {
                    DateTime reservedDate = DateTime.Parse(reserved);
                    b = new Book(id, author, title, publisher, date, user, reservedDate, null);
                }
                else
                {
                    b = new Book(id, author, title, publisher, date, user, null, null);
